        ...
        title: Row(
          children:<Widget> [
            ...
            Column(
              ...
              children: [
                Text(name.toString(), style: TextStyle(fontSize: 17.0, letterSpacing: 2.0, fontWeight: FontWeight.bold),),
                SizedBox(height: 10,),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5.0,),
                    Text(location.toString(), style: TextStyle(fontSize: 14.0,color:Colors.grey),),
                  ],
                ),
                // SizedBox(height: 7,),
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5.0,),
                    Text(code.toString(), style: TextStyle(fontSize: 10.0,color:Colors.grey),),
                  ],
                ),
              ],
            )
